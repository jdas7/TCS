...
public class DataProvider {
    ...
    public void setUserRole(String clientType)
        ...
        userScenario.put("cliente nuevo de la pagina demoblaze", environment.nuevousuario());
        userScenario.put("cliente que ya se registro en la pagina demoblaze", environment.usuario());
